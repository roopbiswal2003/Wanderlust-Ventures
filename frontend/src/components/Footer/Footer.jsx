          ...
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-col items-center mb-4 md:mb-0">
              ...
              <div className="flex flex-col mt-8 text-center md:text-left">
                <p className="mb-2">Address: NIT Rourkela, Sundergarh, Odisha, India</p>
                <p className="mb-2">Phone: +91 1234567890</p>
                <p className="mb-2">Email: info@wanderlustventures.com</p>
                <p>&copy; 2024 Wanderlust Ventures. All rights reserved.</p>
              </div>
            </div>
